...
**Important:** Still **experimental**; local Publishing **≠** external release / consumer-ready claims; true-async memo is [`true-cm-async-memo.en.md`](true-cm-async-memo.en.md) (after this phase). Primary acceptance remains CM cube.
