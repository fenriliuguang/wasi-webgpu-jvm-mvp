...
| **Memo: true CM async / WASI Preview3** | **Memo (not chartered)** — [`true-cm-async-memo.en.md`](true-cm-async-memo.en.md); engineering-handoff has landed — charter separately. sync-compat remains current |
