...
| **Track A mainline: L2 / cube baseline care + Host follow for B** | **Current mainline (chartered 2026-08-14; implementation not started)** — plan [`track-a-baseline-host.en.md`](track-a-baseline-host.en.md). Slices **A→B**: CI/instrumented/lifetime → formal Host surface. **Not** a true-async / compliance-product phase |
