...
| **Compliant wasi:webgpu world (no gfx)** | **In progress (locked; slice A done)** — plan [`compliant-world.en.md`](compliant-world.en.md); gap [`compliant-world-gap.en.md`](../mapping/compliant-world-gap.en.md); vendor [`wit/deps/wasi-webgpu/`](../../wit/deps/wasi-webgpu/). **No** wasi-gfx; Maven / `abi-mvp` render / perf deferred |
