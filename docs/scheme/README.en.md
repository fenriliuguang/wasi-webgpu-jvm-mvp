...
| **True CM async (tier A) / optional P3 spike** | **A gate close-out (2026-08-10; B–E stopped)** — archive [`archive-true-cm-async-dod.en.md`](archive-true-cm-async-dod.en.md). This repo **locks sync-compat**; **no new phase open**. True async / custom Android Wasmtime L1 → sister [`wasmtime-android-kt`](../../../wasmtime-android-kt) (M0–M5 archived; `wasi:webgpu` W1 delivered → **W2**); contract [`dual-runtime-track.en.md`](dual-runtime-track.en.md) |
