...
| **Guest standard descriptors + rotating textured cube** | **Docs-locked** — [`guest-descriptor-cube.en.md`](guest-descriptor-cube.en.md); A natives → B cube demo → C wasi subset wiring → D lifetime. Maven / `abi-mvp` render / perf still deferred |
