...
| **True CM async (tier A) / optional P3 spike** | **A gate close-out (2026-08-10; B–E stopped)** — archive [`archive-true-cm-async-dod.en.md`](archive-true-cm-async-dod.en.md). This repo **locks sync-compat**. True async / custom Android Wasmtime L1 → sister [`wasmtime-android-kt`](../../../wasmtime-android-kt) (M0–M5 archived; `wasi:webgpu` W1 delivered → **W2+**); contract [`dual-runtime-track.en.md`](dual-runtime-track.en.md) |
| **Track A mainline: L2 / cube baseline care + Host follow for B** | **Complete (A–B, 2026-08-15)** — plan [`track-a-baseline-host.en.md`](track-a-baseline-host.en.md); archive [`archive-track-a-baseline-host-dod.en.md`](archive-track-a-baseline-host-dod.en.md). Slices **A→B**: CI/instrumented/lifetime → formal Host surface. **Not** a true-async / compliance-product phase. No new product phase; remains experimental + sync-compat |
