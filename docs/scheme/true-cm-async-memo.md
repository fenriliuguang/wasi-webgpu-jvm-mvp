...
> **状态：已归档（切片 A 闸门关门，2026-08-10）。** 正式计划 / 归档见 [`true-cm-async.md`](true-cm-async.md) · [`archive-true-cm-async-dod.md`](archive-true-cm-async-dod.md)；本页保留为立项前备忘史实。  
> 承接 [engineering-handoff](engineering-handoff.md) 归档（[`archive-engineering-handoff-dod.md`](archive-engineering-handoff-dod.md)）。  
> 仍为 **experimental**；真异步 **未**落地（无 Java future writer）；默认仍为 **sync-compat**（见 [`errors-async.md`](../mapping/errors-async.md)）。

## 一句话

把 wasi:webgpu 0.3 大量 `async func` 从「L2 内 `CountDownLatch` 阻塞等待」换成 **Component Model async（future/stream）**；可选再叠加 **WASI Preview3**。**A 闸门已归档**：范围与 DoD 以 [`true-cm-async.md`](true-cm-async.md) / [`archive-true-cm-async-dod.md`](archive-true-cm-async-dod.md) 为准；主验收 **仍保持** experimental CM cube + sync-compat。
...
- **正式计划 / 归档（现行）：** [`true-cm-async.md`](true-cm-async.md) · [`archive-true-cm-async-dod.md`](archive-true-cm-async-dod.md)  
...
- Upstream 备忘：[`patches/UPSTREAM.md`](../../patches/UPSTREAM.md) §5  
