...
| **合规 wasi:webgpu World（无 gfx）** | **进行中（已锁定 2026-08-09，文档锁定）** — 计划 [`compliant-world.md`](compliant-world.md)；缺口 [`compliant-world-gap.md`](../mapping/compliant-world-gap.md)。**不做** wasi-gfx；移交 Maven / `abi-mvp` render / perf |
