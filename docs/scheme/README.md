...
| **合规 wasi:webgpu World（无 gfx）** | **进行中（A–F 完成）** — 计划 [`compliant-world.md`](compliant-world.md)；缺口 [`compliant-world-gap.md`](../mapping/compliant-world-gap.md)；双轨 [`compliant-world-dual-track.md`](../mapping/compliant-world-dual-track.md)；vendor [`wit/deps/wasi-webgpu/`](../../wit/deps/wasi-webgpu/)。**不做** wasi-gfx |
