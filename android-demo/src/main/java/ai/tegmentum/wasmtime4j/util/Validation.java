...
public final class Validation {
  ...
  /**
   * Validates that a native handle (pointer) is valid (not null).
   *
   * <p>Android ARM64 heap / TBI / PAC pointers may set the high bit; when bit-cast to a signed
   * {@code long} that looks "negative" but is still a valid opaque handle. Only reject zero.
   *
