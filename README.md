...
| 轨 A 主线（计划，已完成） | [track-a-baseline-host](docs/scheme/track-a-baseline-host.md) | [EN](docs/scheme/track-a-baseline-host.en.md) |
| 轨 A 主线 DoD 归档 | [archive-track-a-baseline-host-dod](docs/scheme/archive-track-a-baseline-host-dod.md) | [EN](docs/scheme/archive-track-a-baseline-host-dod.en.md) |
...
| 双运行时轨（A 锁死 sync-compat / B 自研 L1） | [dual-runtime-track](docs/scheme/dual-runtime-track.md) | [EN](docs/scheme/dual-runtime-track.en.md) |
| 真 CM async DoD 归档（A 闸门） | [archive-true-cm-async-dod](docs/scheme/archive-true-cm-async-dod.md) | [EN](docs/scheme/archive-true-cm-async-dod.en.md) |
| 真 CM async（计划，A 闸门已关门） | [true-cm-async](docs/scheme/true-cm-async.md) | [EN](docs/scheme/true-cm-async.en.md) |
| 真 CM async 备忘（立项史实） | [true-cm-async-memo](docs/scheme/true-cm-async-memo.md) | [EN](docs/scheme/true-cm-async-memo.en.md) |
