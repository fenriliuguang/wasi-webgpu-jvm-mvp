...
- **下一阶段（已锁定）：** [工程移交：Maven / abi-mvp render / 可选 perf](docs/scheme/engineering-handoff.md)（A–C；C 可选不阻塞；**尚未实现**）。**不做** wasi-gfx / 合规宣传 / 真 CM async / 上游 PR / 真 dtor overlay。**真机验收基准 = CM cube**
...
| 工程移交（下一阶段，已锁定） | [engineering-handoff](docs/scheme/engineering-handoff.md) | [EN](docs/scheme/engineering-handoff.en.md) |
