...
- **Next (locked)**: [Engineering handoff: Maven / abi-mvp render / optional perf](docs/scheme/engineering-handoff.en.md) (A–C; C optional, non-blocking; **not started**). **No** wasi-gfx / compliance marketing / true CM async / upstream PRs / true dtor overlay. **Device acceptance baseline = CM cube**
...
| Engineering handoff (next phase, locked) | [engineering-handoff.en.md](docs/scheme/engineering-handoff.en.md) |
